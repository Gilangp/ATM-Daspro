...
<<<<<<< HEAD
                            ...
                            while (true) {
                                ...
                                // Mencari nomor kode bank di dalam array
                            ...
                            switch (konfirmasiSetor) {
                                case 'y':
                                    ...
                                    if (inputPin == samplePin) {
                                        ...
                                        System.out.println("-----------------------------------------------");
>>>>>>> e54250db81cc9dc10d4c3b3b32ff561017cc721f
                                    }
                                case 'n':
                                    break;
                            }
...
<<<<<<< HEAD
                                ...
                                if (indexKodeBank == -1) {
                                    System.out.println("Nomor kode bank tidak valid. Mohon masukkan kode bank yang valid.");
                                    continue; // Restart the loop to ask for the destination account again.
                                }
...
>>>>>>> e54250db81cc9dc10d4c3b3b32ff561017cc721f
                                        ...
                                        System.out.println("Nominal transfer harus lebih dari atau sama dengan 5000.");
                                    }
                                } else {
...
>>>>>>> e54250db81cc9dc10d4c3b3b32ff561017cc721f
                                    ...
                                    case 'y':
                                        ...
                                        if (inputPin == samplePin) {
                                            ...
                                            if (jumlahPembayaran <= saldoVA) {
                                                ...
                                                System.out.println(
                                                        "---------------------------------------------------------------");
                                                System.out.println("  Pembayaran sebesar " + jumlahPembayaran
                                                        + " berhasil dilakukan.");
                                                ...
                                                System.out.println(
                                                        "Saldo VA tidak mencukupi untuk melakukan pembayaran.");
                                            }
                                        }
                                }
                            } else {
                        ...
                        case 10:
                            ...
                            System.out.println(
                                    "| - Saat penarikan, saldo minimal anda adalah Rp.50000                                  |");
                            System.out.println(
